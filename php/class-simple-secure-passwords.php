<?php
/**
 * Bootstraps the Simple Secure Passwords plugin.
 *
 ...
 */
class Simple_Secure_Passwords extends Simple_Secure_Passwords_Base {
	...
	public function init() {
		$this->config = apply_filters( 'simple_secure_passwords_plugin_config', $this->config, $this );
	}
